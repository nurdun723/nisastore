...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="<?php echo (STYLE_URL); ?>style.css" rel="stylesheet" type="text/css" />
    ...
    <body style="cursor: auto;">
        ...
        <div class="block clearfix">
                ...
                <div style="display: block;" class="box" id="history_div">
                    ...
                    <div class="box_1">
                        ...
                        <div class="boxCenterList clearfix" id="history_list">
                            <ul class="clearfix"><li class="goodsimg"><a href="#" target="_blank"><img src="<?php echo (IMAGE_URL); ?>8_thumb_G_1241425513488.jpg" alt="飞利浦9@9v" class="B_blue"></a></li><li><a href="#" target="_blank" title="飞利浦9@9v">飞利浦9@9v</a><br />本店售价：<font class="f1">￥399元</font><br /></li></ul><ul class="clearfix"><li class="goodsimg"><a href="#" target="_blank"><img src="<?php echo (IMAGE_URL); ?>9_thumb_G_1241511871555.jpg" alt="诺基亚E66" class="B_blue"></a></li><li><a href="#" target="_blank" title="诺基亚E66">诺基亚E66</a><br />本店售价：<font class="f1">￥2298元</font><br /></li></ul><ul class="clearfix"><li class="goodsimg"><a href="#" target="_blank"><img src="<?php echo (IMAGE_URL); ?>17_thumb_G_1241969394587.jpg" alt="夏新N7" class="B_blue"></a></li><li><a href="#" target="_blank" title="夏新N7">夏新N7</a><br />本店售价：<font class="f1">￥2300元</font><br /></li></ul><ul id="clear_history"><a onclick="clear_history()">[清空]</a></ul>  </div>
                    </div>
                </div>
                <div class="blank5"></div>
            </div>
            ...
            <div class="AreaR">
                <div id="goodsInfo" class="clearfix">
                    <div class="imgInfo">
                        <a style="position: relative; display: block; outline: 0pt none; text-decoration: none; width: 310px; -moz-user-select: none;" href="<?php echo (IMAGE_URL); ?>200905/goods_img/9_P_1241511871575.jpg" id="zoom1" class="MagicZoom MagicThumb" title="诺基亚E66">
                            <img id="sim806035" src="<?php echo (IMAGE_URL); ?>9_G_1241511871574.jpg" alt="诺基亚E66" height="310px" width="310px;" />
                            <div class="MagicZoomBigImageCont" style="width: 200px; height: 269px; overflow: hidden; z-index: 100; visibility: visible; position: absolute; top: -10000px; left: 327px; display: block;" id="bc806035">
                                ...
                                <div style="overflow: hidden;">
                                    <img style="position: relative; border-width: 0px; padding: 0px; left: 0px; top: 0px; display: block; visibility: visible;" src="<?php echo (IMAGE_URL); ?>9_P_1241511871575.jpg" />
                                </div>
                        ...
                        <div style="text-align: center; position: relative; width: 100%;">
                            <a href="#">
                                <img style="position: absolute; left: 0pt;" alt="prev" src="<?php echo (IMAGE_URL); ?>up.gif" /></a>
                            <a href="javascript:;" onclick="window.open('gallery.php?id=9'); return false;">
                                <img alt="zoom" src="<?php echo (IMAGE_URL); ?>zoom.gif" />
                            </a>
                            <a href="#">
                                <img style="position: absolute; right: 0pt;" alt="next" src="<?php echo (IMAGE_URL); ?>down.gif" /></a>
                        </div>
                        <div class="blank5"></div>

                        <div class="picture" id="imglist">
                            <a style="outline: 0pt none;" href="<?php echo (IMAGE_URL); ?>200905/goods_img/9_P_1241511871575.jpg" rel="zoom1" rev="images/200905/goods_img/9_P_1241511871575.jpg" title="">
                                <img src="<?php echo (IMAGE_URL); ?>9_thumb_P_1241511871787.jpg" alt="诺基亚E66" class="onbg" /></a>
                        </div>
                    </div>
                        ...
                        <form action="javascript:addToCart(9)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY">
                            ...
                            <ul>
                                ...
                                <li class="clearfix">
                                    <dd>
                                        <strong>用户评价：</strong>
                                        <img src="<?php echo (IMAGE_URL); ?>stars5.gif" alt="comment rank 5">
                                    </dd>
                                </li>
                                <li class="padd">
                                ...
                                <li class="padd">
                                    <a href="#"><img src="<?php echo (IMAGE_URL); ?>goumai2.gif"></a>
                                    <a href="#"><img src="<?php echo (IMAGE_URL); ?>shoucang2.gif"></a>
                                    <a href="#"><img src="<?php echo (IMAGE_URL); ?>tuijian.gif"></a>
                                </li>
                            </ul>
                        </form>
                    </div>
                ...
                <div class="box">
                    <div class="box_1">
                        ...
                        <div class="boxCenterList clearfix ie6">
                            <div class="goodsItem">
                                <a href="#">
                                    <img src="<?php echo (IMAGE_URL); ?>24_thumb_G_1241971981429.jpg" alt="P806" class="goodsimg"></a><br />
                                <p><a href="#" title="P806">P806</a></p> 
                                <font class="shop_s">￥2000元</font>
                            </div>
                            <div class="goodsItem">
                                <a href="#">
                                    <img src="<?php echo (IMAGE_URL); ?>22_thumb_G_1241971076803.jpg" alt="多普达Touch HD" class="goodsimg" /></a><br />
                                <p><a href="#" title="多普达Touch HD">多普达Touc...</a></p> 
                                <font class="shop_s">￥5999元</font>
                            </div>
                            <div class="goodsItem">
                                <a href="#">
                                    <img src="<?php echo (IMAGE_URL); ?>13_thumb_G_1241968002527.jpg" alt="诺基亚5320 XpressMusic" class="goodsimg" /></a><br />
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <div style="padding-left: 15px; text-align: left; float: left;">
                                                            ...
                                                            <img src="<?php echo (IMAGE_URL); ?>captcha.png" alt="captcha" onclick="this.src='captcha.php?'+Math.random()" class="captcha" />
                                                        </div>
        ...
        <div id="bottomNav" class="box block">
            <div class="box_1">
                <div class="links clearfix"> 
                    <a href="#" target="_blank" title="YONGDA商城"><img src="<?php echo (IMAGE_URL); ?>goods.htm" alt="YONGDA商城" border="0" /></a>
        ...
        <img class="MagicThumb-image" style="position: absolute; top: -9999px; display: none;" src="<?php echo (IMAGE_URL); ?>9_P_1241511871575.jpg" />
        <img src="<?php echo (IMAGE_URL); ?>controlbar.htm" style="position: absolute; top: -999px;" />
        <img style="position: absolute; left: -10000px; top: -10000px;" src="<?php echo (IMAGE_URL); ?>9_P_1241511871575.jpg" />
        <img style="position: absolute; left: -10000px; top: -10000px;" src="<?php echo (IMAGE_URL); ?>9_P_1241511871575.jpg" />
    </body>
</html>